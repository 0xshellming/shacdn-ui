export function GetBlocks() {
    return <a
        className="hidden h-12 animate-pulse items-center gap-2 rounded-md bg-neutral-100 px-5 transition-colors  hover:bg-neutral-200 md:flex dark:bg-neutral-800 dark:hover:bg-neutral-700"
    ...
    >
        ...
        >
            <path
                d="M46.7305 4.50988L43.6252 2.72961V17.49L46.7305 19.2925V4.50988Z"
                fill="currentColor"
            />
            <path
            ...
            />
            <path
                d="M59.1814 11.7684L56.0762 9.98816V24.7486L59.1814 26.5326V11.7684Z"
                fill="currentColor"
            />
            <path
        ...
        <div className="flex flex-col">
            ...
            <span className="text-xs text-neutral-400">600+ extra shadcn blocks</span>
        </div>
    </a>
}  